...
import { fetchSocialOrganizations } from "@/modules/provider/api/social-organizations";
import { SocialOrganizationsListResponse } from "@/shared/types/social-organizations";
