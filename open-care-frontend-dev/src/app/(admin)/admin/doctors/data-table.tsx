...
export function DataTable<TData, TValue>({
	...
	const doctorNameColumn =
		table.getColumn("doctor-name") ?? table.getColumn("profile.name");
				...
				<div className="flex items-center space-x-2">
					<div className="relative flex-1 max-w-sm">
						...
						<Input
							...
							value={(doctorNameColumn?.getFilterValue() as string) ?? ""}
							onChange={(event) =>
								doctorNameColumn?.setFilterValue(event.target.value)
							}
							className="pl-8"
						/>
					</div>
