...
For demo readiness, ensure these records exist in your running environment:
- one admin-capable user
- one approved doctor (`isVerified=true`, `isActive=true`)
- one patient user
...
- Frontend setup for end-to-end demo: `../open-care-frontend-dev/README.md`
