...
public interface AmbulanceMapper {
    ...
    @Mapping(source = "type", target = "type", qualifiedByName = "ambulanceTypeEnumToResponse")
    ...
    @Named("ambulanceTypeEnumToResponse")
    default AmbulanceTypeResponse ambulanceTypeEnumToResponse(AmbulanceType ambulanceType) {
        return ambulanceType != null ? ambulanceType.toResponse() : null;
    }

    @Named("ambulanceTypeStringToEnum")
    default AmbulanceType ambulanceTypeStringToEnum(String ambulanceType) {
        return StringUtils.hasText(ambulanceType) ? AmbulanceType.valueOf(ambulanceType) : null;
    }
